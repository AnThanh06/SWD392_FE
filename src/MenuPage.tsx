        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg relative z-10 overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
                ...
                <div className="relative h-48 shrink-0">
                    <img src={currentProduct.imageUrl || "https://via.placeholder.com/500"} className="w-full h-full object-cover" alt="" />
                        ...
                        <div className="space-y-2">
                            {currentProduct.variants.map(v => (
                                <div 
                                    ...
                                    className={`cursor-pointer p-3 border rounded-xl flex justify-between items-center transition-all ${
                                    ...
                                    return (
                                        <div 
                                            ...
                                            className={`flex items-center justify-between p-3 rounded-xl border cursor-pointer transition-all ${
                                                isSelected ? 'border-orange-500 bg-orange-50' : 'border-gray-100 hover:bg-gray-50'
                                            }`}
                                        >
